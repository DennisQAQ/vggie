...
import com.dw.vggie.dto.OrderDTO;
...
public class OrdersController {
    ...
    public R<Page> userPage(int page,int pageSize){
        ...
        LambdaQueryWrapper<Orders> queryWrapperForOrder =new LambdaQueryWrapper<>();
        queryWrapperForOrder.eq(null!=currentId,Orders::getUserId,currentId);
        queryWrapperForOrder.orderByDesc(Orders::getOrderTime);
        ordersService.page(ordersPage, queryWrapperForOrder);

        //对OrderID查询对应的orderDetail信息
        LambdaQueryWrapper<OrderDTO> queryWrapperForOrderDTO = new LambdaQueryWrapper<>();
        ...
        List<OrderDTO> dtoList = records.stream().map((item) -> {
            ...
            orderDTO.setOrderDetails(orderDetailByOrderId);
            return orderDTO;
